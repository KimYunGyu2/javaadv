                ...
                <div class="rounded d-flex justify-content-center">
                    <div class="col-md-4 col-sm-12 shadow-lg p-5 bg-light">
                        <div class="text-center">
                            <h3 class="text-primary">회원탈퇴</h3>
                        </div>
                        <form name = "frm" action="userbyedb.jsp" method="post">
                            <div class="p-4">
                                ...
                                <button class="btn btn-danger text-center mt-2" type="submit" onclick="fn_submit(); return false;">  회원탈퇴 </button>
